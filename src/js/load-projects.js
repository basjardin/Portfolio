document.addEventListener("DOMContentLoaded", () => {
  ...
  if (typeof projectsData === "undefined") {
    console.error(
      "projectsData is not defined. Make sure projects-data.js is loaded before load-projects.js"
    );
    return;
  }
  ...
  projectsData.forEach((project) => {
    ...
    if (carouselElement) {
      ...
      console.warn(
        `Carousel with ID "${project.targetCarouselId}" not found for project "${project.title}"`
      );
    }
  });
